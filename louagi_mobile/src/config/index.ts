// src/config/index.ts - Updated with Your New Ngrok URL
const Config = {
  // 🌐 Your Backend URL - UPDATED TO MATCH YOUR CURRENT NGROK
  API_BASE_URL: 'https://b268-165-50-8-74.ngrok-free.app/api', // ← UPDATED!
